...
namespace IK_Project.Infrastructure.Migrations
{
    ...
    [Migration("20230425123356_mig-Role")]
            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f7d190c3-0553-416d-b2ec-85cfd907c3aa"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 469, DateTimeKind.Local).AddTicks(8546),
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("0127c4a0-87cc-43de-bf1f-9e48fe4b295e"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 469, DateTimeKind.Local).AddTicks(8563),
                            Name = "CompanyManager",
                        ...
                        new
                        {
                            Id = new Guid("f289c038-cd2c-4c1f-923d-93a7b13a36fd"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 469, DateTimeKind.Local).AddTicks(8566),
                            Name = "Employee",
            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1510),
                            Currecy = 0,
                            Name = "Basic",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1506),
                            Status = 1,
                            UnitPrice = 1000m,
                            UserAmount = 100
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1516),
                            Currecy = 0,
                            Name = "Standart",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1514),
                            Status = 1,
                            UnitPrice = 2000m,
                            UserAmount = 200
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1520),
                            Currecy = 0,
                            Name = "Premium",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 15, 33, 56, 470, DateTimeKind.Local).AddTicks(1519),
                            Status = 1,
                            UnitPrice = 3000m,
                            UserAmount = 300
                        });
