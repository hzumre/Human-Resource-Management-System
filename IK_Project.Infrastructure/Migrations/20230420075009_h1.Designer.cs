            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5542),
                            Currecy = 0,
                            Name = "Basic",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5525),
                            Status = 1,
                            UnitPrice = 1000m,
                            UserAmount = 100
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5551),
                            Currecy = 0,
                            Name = "Standart",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5549),
                            Status = 1,
                            UnitPrice = 2000m,
                            UserAmount = 200
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5556),
                            Currecy = 0,
                            Name = "Premium",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 20, 10, 50, 8, 984, DateTimeKind.Local).AddTicks(5554),
                            Status = 1,
                            UnitPrice = 3000m,
                            UserAmount = 300
                        });
