...
namespace IK_Project.Infrastructure.Migrations
{
    ...
    [Migration("20230419094946_mig_PackagesSeedData")]
    partial class mig_PackagesSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(7019),
                            Currecy = 0,
                            Name = "Basic",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(6986),
                            Status = 1,
                            UnitPrice = 1000m,
                            UserAmount = 100
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(7027),
                            Currecy = 0,
                            Name = "Standart",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(7025),
                            Status = 1,
                            UnitPrice = 2000m,
                            UserAmount = 200
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(7033),
                            Currecy = 0,
                            Name = "Premium",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 12, 49, 46, 595, DateTimeKind.Local).AddTicks(7032),
                            Status = 1,
                            UnitPrice = 3000m,
                            UserAmount = 300
                        });
            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Salary", b =>
                {
                    b.HasOne("IK_Project.Domain.Entities.Concrete.Employee", null)
                        .WithMany("Salaries")
                        .HasForeignKey("EmployeeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
