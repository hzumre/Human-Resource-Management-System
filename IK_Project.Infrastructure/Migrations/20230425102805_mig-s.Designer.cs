...
namespace IK_Project.Infrastructure.Migrations
{
    ...
    [Migration("20230425102805_mig-s")]
    partial class migs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(630),
                            Currecy = 0,
                            Name = "Basic",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(618),
                            Status = 1,
                            UnitPrice = 1000m,
                            UserAmount = 100
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(636),
                            Currecy = 0,
                            Name = "Standart",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(635),
                            Status = 1,
                            UnitPrice = 2000m,
                            UserAmount = 200
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(640),
                            Currecy = 0,
                            Name = "Premium",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 25, 13, 28, 5, 109, DateTimeKind.Local).AddTicks(639),
                            Status = 1,
                            UnitPrice = 3000m,
                            UserAmount = 300
                        });
