            ...
            modelBuilder.Entity("IK_Project.Domain.Entities.Concrete.Menu", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(586),
                            Currecy = 0,
                            Name = "Basic",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(569),
                            Status = 1,
                            UnitPrice = 1000m,
                            UserAmount = 100
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(590),
                            Currecy = 0,
                            Name = "Standart",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(589),
                            Status = 1,
                            UnitPrice = 2000m,
                            UserAmount = 200
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(593),
                            Currecy = 0,
                            Name = "Premium",
                            Period = "3",
                            ReleaseDate = new DateTime(2023, 4, 19, 14, 56, 42, 215, DateTimeKind.Local).AddTicks(593),
                            Status = 1,
                            UnitPrice = 3000m,
                            UserAmount = 300
                        });
